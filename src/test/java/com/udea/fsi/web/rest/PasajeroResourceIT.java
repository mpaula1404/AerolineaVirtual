...
import static com.udea.fsi.domain.PasajeroAsserts.*;
...
import com.udea.fsi.repository.PasajeroRepository;
...
class PasajeroResourceIT {
    ...
    void partialUpdatePasajeroWithPatch() throws Exception {
        ...
        partialUpdatedPasajero.nombre(UPDATED_NOMBRE).email(UPDATED_EMAIL).telefono(UPDATED_TELEFONO);
